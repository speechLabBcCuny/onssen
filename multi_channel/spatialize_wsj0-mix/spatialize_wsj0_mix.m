...
function spatialize_wsj0_mix(num_speakers,min_or_max,fs,start_ind,stop_ind,useparcluster_with_ind,generate_rirs)
    ...
    data_in_root  = '/scratch/near/'; % directory of the original wsj0-mix data
    rir_root      = '/scratch/near/wsj0-mix-spatialized/'; % directory to write the generated RIRs into
    data_out_root = '/scratch/near/wsj0-mix-spatialized/'; % directory to write the spatialized mixtures into
    ...
    NUM_UTT_IN_WSJ_MIX = 20000+5000+3000;
