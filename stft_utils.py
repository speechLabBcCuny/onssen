...
def plot_stft(signal, file_name, title=None, win_length=None, hop_length=None,
              window_type=None, sample_rate=8000, n_fft_bins=None,
...
def e_stft(signal, window_length, hop_length, window_type,
    ...
    window_type = 'hamming' if window_type is None else window_type
...
def e_istft(stft, n_sample, window_length, hop_length, window_type, reconstruct_reflection=True, remove_padding=True):
    """
    ...
    norm_window[norm_window == 0.0] = 1e-7  # Prevent dividing by zero
